...
async function deleteSession(sessionId) {
  const d = await supabase.from("course_sessions").delete().eq("id", sessionId);
  if (d.error) {
    setError(d.error);
...
return (
  <div className="page page--runs">
    <div className="container runDetails">
                    ...
                    <div className="pMain">
                      ...
                      <div className="pBig" title=" ">
                        ...
                        <div className="muted" style={{ fontSize: 12 }}>
                          ...
                          <span style={{ opacity: 0.55 }}>Sessions in run</span>
      ...
      {tab === "sessions" && (
        <div className="grid">
          ...
          <div className="card" style={{ gridColumn: "span 7" }}>
            ...
            <div className="muted" style={{ marginTop: 6 }}>
              Manage sessions for this run. Create, edit, or delete sessions as
              needed.
            </div>
          ...
          <div style={{ gridColumn: "span 12" }} className="card">
            {pkgLoading ? (
              ...
              <div className="muted">
                ...
                <b>{Number(pkgInfo.sessions_remaining || 0)}</b> — Remaining to
      ...
      {/* Edit */}
      <Modal open={openPrice} title="Edit " onClose={() => setOpenPrice(false)}>
        <div style={{ display: "grid", gap: 10 }}>
          <div className="muted">Duration (minutes)</div>
          <input
            className="input"
      ...
      {/* */}
      <Modal open={openHistory} title=" " onClose={() => setOpenHistory(false)}>
