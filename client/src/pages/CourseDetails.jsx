...
return (
  <div className="container page page--courses" dir="rtl">
    <PageHeader
      ...
      actions={
        <>
          <button className="btn" onClick={() => navigate("/courses")}></button>
    ...
    <div className="grid" style={{ marginTop: 10 }}>
      <div style={{ gridColumn: "span 3" }}>
        <KpiCard
          ...
          hint={stats.totalRuns ? ` ${stats.totalRuns}` : "No "}
          icon={Layers}
        />
      </div>
              ...
              <div className="runCard__top">
                <div>
                  ...
                  <div className="muted" style={{ marginTop: 4 }}>
                    : <span className="ltrIso">{course.capacity}</span> • No:{" "}
    ...
    <Modal open={open} title=" " onClose={() => setOpen(false)}>
      ...
      <div className="grid">
        ...
        <div className="row" style={{ gridColumn: "span 12", marginTop: 6 }}>
          <button className="btn primary" disabled={saving} onClick={createRun}>
            {saving ? " ..." : " "}
          </button>
