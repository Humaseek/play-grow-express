-- Allow negative balance (overpayment/credit) in both views
-- Previously GREATEST(..., 0) clamped balance to zero minimum

-- 1. Recreate run_participants_view without GREATEST on balance
...
-- 2. Recreate package_balance_view without GREATEST on balance_amount
